		...
		return (
			React.createElement('div', {className: 'text-center mb-2 mt-3'},
				React.createElement('div', {className: 'controls' },
					...
					React.createElement('a', {className: 'btn btn-secondary pl-2 ml-2',href:'#',onClick: this.get}, 'add to list'),
					React.createElement('a', {className: 'btn btn-secondary pl-2 ml-2',href:'#',onClick: this.clear}, 'clear list')
				),
				React.createElement('div', {id: 'stopwatch', className: "mt-3"},this.print()),
